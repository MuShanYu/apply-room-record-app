          ...
          <block>
            ...
            <view class="login__info__item__input tn-flex tn-flex-direction-row tn-flex-nowrap tn-flex-col-center tn-flex-row-left">
              ...
              <view class="login__info__item__input__right-verify-code" >
                <tn-button backgroundColor="#3668FC" fontColor="#FFFFFF" size="sm" padding="5rpx 10rpx" width="100%" shape="round">{{ tip }}</tn-button>
              </view>
            </view>
            ...
            <view class="login__info__item__input tn-flex tn-flex-direction-row tn-flex-nowrap tn-flex-col-center tn-flex-row-left">
              ...
              <view class="login__info__item__input__content">
                <input maxlength="12" :password="!showPassword" placeholder-class="input-placeholder" placeholder="请输入新密码" />
              </view>
              <view class="login__info__item__input__right-icon" @click="showPassword = !showPassword">
                <view :class="[showPassword ? 'tn-icon-eye' : 'tn-icon-eye-hide']"></view>
					...
					<view class="login__info__item__input tn-flex tn-flex-direction-row tn-flex-nowrap tn-flex-col-center tn-flex-row-left">
					    ...
					    <view class="login__info__item__input__content">
					      <input maxlength="12" :password="!showPassword" placeholder-class="input-placeholder" placeholder="请确认新密码" />
					    </view>
					    <view class="login__info__item__input__right-icon" @click="showPassword = !showPassword">
					      <view :class="[showPassword ? 'tn-icon-eye' : 'tn-icon-eye-hide']"></view>
					    </view>
