<template>
	<view class="page">
		...
		<view class='nav-list tn-margin-bottom tn-margin-top'>
		  ...
		  <view @click="tn('/pages/sub-page/work/apply-room')" class="nav-list-item tn-shadow-blur tn-cool-bg-image home-shadow">
		    <view class="nav-link">
		...
		<view class='nav-list tn-margin-bottom tn-margin-top'>
		  ...
		  <view class="nav-list-item tn-shadow-blur tn-cool-bg-image home-shadow">
			...
			<view class="nav-list-item tn-shadow-blur tn-cool-bg-image home-shadow">
			  <view class="nav-link">
			    <view class='title tn-text-bold' style="color: #080808;">申请审批</view>
			    <view class='join'></view>
			  </view>
