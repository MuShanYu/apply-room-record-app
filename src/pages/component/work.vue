<template>
	<view class="page">
		...
		<view class='nav-list tn-margin-bottom tn-margin-top'>
			...
			<view @click="tn('/page-work/apply-room/index')"
			...
			<view @click="tn('/page-work/sign-in-apply/index')"
				class="nav-list-item tn-shadow-blur tn-cool-bg-image home-shadow">
				<view class="nav-link">
		...
		<view class='nav-list tn-margin-bottom tn-margin-top'>
			...
			<view @click="tn('/page-work/approve-room/index')"
				class="nav-list-item tn-shadow-blur tn-cool-bg-image home-shadow">
				<view class="nav-link">
		...
		<view class='nav-list tn-margin-bottom tn-margin-top'>
			...
			<view @click="tn('/page-work/sign-in/index')"
				class="nav-list-item tn-shadow-blur tn-cool-bg-image home-shadow">
				<view class="nav-link">
